<template>
  <div class="detail">
    ...
    <div class="card">
      <div class="type">
        <span :class="{ expense: detail.payType == 1, income: detail.payType == 2 }">
          <i class="iconfont" :class="detail.type ? detail.type.icon : 'qita'" />
        </span>
        <span>{{ detail.typeName || '' }}</span>
      </div>
      <div class="amount expense" v-if="detail.payType == 1">-{{ detail.amount }}</div>
